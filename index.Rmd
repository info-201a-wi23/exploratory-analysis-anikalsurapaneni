...
```{r, include = FALSE}
  ...
  whc_df = read.csv("https://raw.githubusercontent.com/info-201a-wi23/exploratory-analysis-anikalsurapaneni/main/finalwhc.csv")
  whc_sub <- whc_df %>%
...
This table reveals which of the earliest inscribed heritage sites are now considered in danger. 
